...
API_HASH = environ.get('API_HASH', 'ddc284e5fdc33ef38845f7a5e9142f50')
BOT_TOKEN = environ.get('BOT_TOKEN', "7658413075:AAHZne6YRBxJcBUmbWNDwfsJGBI92sGhxtE")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5405110137').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002297380012'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002480801218').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tjagan416:itachiuchiha@cluster0.pgqu1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
